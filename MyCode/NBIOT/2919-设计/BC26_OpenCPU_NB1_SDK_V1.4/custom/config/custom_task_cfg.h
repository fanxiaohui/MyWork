...
//Add custom Gpio task
//TASK_ITEM(proc_reserved3,       reserved3_id,   5*1024,  DEFAULT_VALUE1, DEFAULT_VALUE2)  //GPIO task

///Add custom IIC task
TASK_ITEM(proc_reserved5,       reserved5_id,   5*1024,  DEFAULT_VALUE1, DEFAULT_VALUE2)  //IIC task
